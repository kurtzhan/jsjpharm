...
/* JS代码增加_S  By www.68ecshop.com 立即购买 */
...
/* JS代码增加_E  By www.68ecshop.com 立即购买 */
/* *
 * 添加商品到购物车 
 */
...
/* 代码修改_start By www.68ecshop.com  这里增加了一个变量 */
...
function opencartDiv(price,name,pic,goods_brief,goods_id,total,number,boutgoods1)
{
var _id = "speDiv";
var m = "mask";
...
//生成层内内容
html = '<div class="iDialog iDialogNoTitle mallCartPop autoWidthDialog" style="visibility: visible; z-index: 1000; margin-left: -286px; left: 50%; margin-top: -212px; top: 50%; cursor: move;" id="iDialog0"><table class="iDialogWrapTable"><tbody><tr><td class="itd-top-left"></td><td class="itd-top-center"></td><td class="itd-top-right"></td></tr> <tr><td class="itd-mid-left"></td><td class="itd-mid-center"><div class="iDialogContent"><a class="iDialogClose" hidefocus="true" href=\'javascript:cancel_div()\'></a><div class="iDialogBody"><div class="iDialogMain"><dl class="cartInfo clearfix"><dt><span class="sign sign7 fl mr10"></span></dt><dd><p><strong class="c_4b8400">添加成功！</strong><br>购物车共有'+number+'件商品，合计：<strong class="c_ba2636">'+total+'</strong></p><p class="mt10"><a class="ff_song" href=\'javascript:cancel_div()\' name="js_close">&lt;&lt; 再逛逛</a>　<a class="oGreenBtn" href="flow.php">去购物车结算</a></p></dd></dl>';
html +='<h4>购买过该商品的用户还购买了：</h4><div class="cartProWrap clearfix">';
var i1 = 0;

while (boutgoods1[i1] && i1 < 4)
{
html +=' <div class="product"><a href="'+boutgoods1[i1]["url"]+'" target="_blank" class="productImg"><img width="100" border="0" height="100" src="'+boutgoods1[i1]["goods_img"]+'" alt="'+boutgoods1[i1]["name"]+'" title="'+boutgoods1[i1]["name"]+'"></a><p class="introduceTit">'+boutgoods1[i1]["brief"]+'</p><p class="productTit"><a target="_blank" title="'+boutgoods1[i1]["name"]+'" href="'+boutgoods1[i1]["url"]+'">'+boutgoods1[i1]["name"]+'</a></p><p class="productPrice">'+boutgoods1[i1]["shop_price"]+'</p></div>';
i1++;
}
html +='</div></div></div></div></td><td class="itd-mid-right"></td></tr><tr><td class="itd-bot-left"></td><td class="itd-bot-center"></td><td class="itd-bot-right"></td></tr></tbody></table></div>';
